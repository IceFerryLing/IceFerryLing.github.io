...
之前我写过一篇分析 `O(1)调度算法` 的文章：[O(1)调度算法](/series/linux-source-code-analyze/process-schedule-o1/)，而这篇主要分析 Linux 现在所使用的 `完全公平调度算法`。
...
![cpu-timeline](/assets/images/linux-source-code/cpu-timeline.png)
...
![red-black-tree](/assets/images/linux-source-code/red-black-tree.png)
...
![csf-runqueue](/assets/images/linux-source-code/csf-runqueue.png)
