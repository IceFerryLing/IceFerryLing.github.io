...
![ip-message](/assets/linux-source-code/images/ip-message.png)
...
![ip-router](/assets/linux-source-code/images/ip-router.png)
...
![ip-address](/assets/linux-source-code/images/ip-address-1.png)
...
![ip-address](/assets/linux-source-code/images/ip-address.png)

有了 `IP地址` 后，就可以为互联网上的每台计算机设置 `IP地址`，如下图：

![ip-network](/assets/linux-source-code/images/ip-network-2.png)
...
![ip-header](/assets/linux-source-code/images/ip-header.png)
...
![ip-package](/assets/linux-source-code/images/ip-package.png)
