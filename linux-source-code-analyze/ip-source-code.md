...
![ip-message](/assets/linux-source-code/ip-message.png)
...
![ip-router](/assets/linux-source-code/ip-router.png)
...
![ip-address](/assets/linux-source-code/ip-address-1.png)
...
![ip-address](/assets/linux-source-code/ip-address.png)

有了 `IP地址` 后，就可以为互联网上的每台计算机设置 `IP地址`，如下图：

![ip-network](/assets/linux-source-code/ip-network-2.png)
...
![ip-header](/assets/linux-source-code/ip-header.png)
...
![ip-package](/assets/linux-source-code/ip-package.png)
