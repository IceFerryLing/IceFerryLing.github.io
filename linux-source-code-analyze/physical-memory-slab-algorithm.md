...
用图来表示它们之间的关系，如下：
![enter image description here](/assets/images/linux-source-code/memory_slab_global.png)
...
一个slab的结构如下图：
![enter image description here](/assets/images/linux-source-code/memory_slab.png)
